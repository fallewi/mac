//La fonction ne fonctionne pas, je drois remplacer l'original dans website_sale'
odoo.define('mac_custom.website_sale2', function (require) {
    "use strict";

    var website_sale = require('website_sale.website_sale');

    var website_sale2 = website_sale
